...
void AVLTree::show(Node * root) {
	// TODO
	// Exiber a árvore em ordem (in-order)
	// Deve exibir o valor da chave, a altura e o fator de balancemento (BF()) por nó da árvore
	// Formato: (<valor>, <altura>, <BF>), separado por espaços, exemplo:
